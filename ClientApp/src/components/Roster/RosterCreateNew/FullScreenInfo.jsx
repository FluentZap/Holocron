...
const FullScreenInfo = ({ text, onClick }) => {
  ...
  return <>
    <div className='flex-center data-panel red-flat scanlines-back m2 p2 z-overlay' style={{gridArea: '4 / 1 / span 37 / span 20', justifyContent: 'start' }} />
    <div className='flex-center z-overlay-child m2' style={{gridArea: '8 / 2 / span 32 / span 18', display: 'block', overflowY: 'auto', width: '99%', margin: '.5vh 0' }} >
