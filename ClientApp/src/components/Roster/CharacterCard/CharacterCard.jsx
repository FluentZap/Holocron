...
const CharacterCard = ({ fadeDelay, stats }) => {
    return (
        <div className='animate-fade-in roster-character-card' style={{ gridArea: '3 / 1 / span 10 / span 20', animationDelay: fadeDelay }}>
            ...
            <div className='font-small animate-fade-in z-5 m2 p2 flex-left data-panel gray-flat scanlines-back roster-text'
            ...
            <div className='font-small animate-fade-in z-5 m2 p1 flex-left data-panel gray-flat scanlines-back roster-text'
