  ...
  return (
    <div className='flex-center login-root'>
      <div className='login-container'>
        <div className='flex-center login-background' style={{ gridArea: '9 / 1 / span 24 / span 20' }} />
        <div className='flex-center login-heading' style={{ gridArea: '11 / 4 / span 3 / span 14' }} >HoloCron</div>
        <input className='login-input m2 p2' style={{ gridArea: '16 / 4 / span 4 / span 14' }} placeholder={'Username'} type="text" onChange={event => setUserName(event.target.value)} />
        <input onKeyUp={event => {
          if (event.key === 'Enter') {
            LoginUser();
          }
        }
        } className='login-input m2 p2' style={{ gridArea: '20 / 4 / span 4 / span 14' }} placeholder={'Password'} type="password" onChange={event => setPassword(event.target.value)} />
        {userName === '' || password === '' ?
          <>
